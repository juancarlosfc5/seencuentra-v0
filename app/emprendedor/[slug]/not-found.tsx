...
export default function EntrepreneurNotFound() {
  return (
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Emprendedor no encontrado</h1>
            <p className="text-lg text-gris-suave max-w-2xl mx-auto">
              Lo sentimos, el perfil del emprendedor que buscas no existe o ha sido removido.
            </p>
          </div>
